          ...
          send: function (a, e) {
            ...
            d.onload = function () {
              var a =
                ...
                b = 200,
                c = 'success',
                f = { text: d.responseText };
              try {
                if ('html' === l || /text\/html/i.test(d.contentType))
                  f.html = d.responseText;
                else if ('json' === l || ('text' !== l && /\/json/i.test(d.contentType)))
                  try {
                  ...
                  if (
                    ...
                    throw (
                      ((b = 500), (c = 'parseerror'), 'Invalid XML: ' + d.responseText)
                    );
                  f.xml = h;
                }
              } catch (m) {
            ...
            d.onerror = function () {
              e(500, 'error', { text: d.responseText });
            };
...
(function () {
  ...
  if (!window.TradingView) {
    var k = {
        mobile: {
          disabledFeatures:
            'left_toolbar header_widget timeframes_toolbar edit_buttons_in_legend context_menus control_bar border_around_the_chart'.split(
              ' ',
            ),
      ...
      e = {
        ...
        HOLLOW_CANDLES: 9,
        version: function () {
          return '1.7 (internal id 547dca23 @ 2016-10-31 23:12:31.646631)';
        },
        gEl: function (a) {
    ...
    e.widget.prototype = {
      ...
      _autoResizeChart: function () {
        this.options.fullscreen &&
          $(e.gEl(this.id)).css('height', $(window).height() - 200 + 'px');
      },
      create: function () {
        var a = this.render(),
          b = this,
        ...
        if (this.options.autosize || this.options.fullscreen)
          (f = $(e.gEl(this.id))),
            f.css('width', '100%'),
            this.options.fullscreen || f.css('height', '100%');
      ...
      render: function () {
        ...
        var a =
          (this.options.path || '') +
          'static/tv-chart.547dca23808868d07ef7.html#localserver=1&symbol=' +
    ...
    window.TradingView && jQuery
      ? jQuery.extend(window.TradingView, e)
      : (window.TradingView = e);
  }
})();
