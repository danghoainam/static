...
Datafeeds.UDFCompatibleDatafeed.prototype.defaultConfiguration = function () {
  return {
    ...
    supported_resolutions: ['1', '5', '15', '30', '60', '1W', '1M'],
...
Datafeeds.UDFCompatibleDatafeed.prototype.onReady = function (callback) {
  ...
  if (this._configuration) {
    setTimeout(function () {
      // Bổ sung cấu hình để đảm bảo hỗ trợ các độ phân giải
      callback({
        ...
        supports_timescale_marks: false,
        supports_time: true,
        supported_resolutions: ['1S', '5', '15', '30', '60', 'D', 'W', 'M'], // Độ phân giải
        intraday_multipliers: ['1S', '5', '15', '30', '60'], // Intraday multipliers
        intraday: true,
        has_intraday: true,
      });
    }, 0);
    ...
    this.on('configuration_ready', function () {
      callback({
        ...
        supports_timescale_marks: false,
        supports_time: true,
        supported_resolutions: ['1S', '5', '15', '30', '60', 'D', 'W', 'M'],
        intraday_multipliers: ['1S', '5', '15', '30', '60'],
        Intraday: true,
      });
    });
  }
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (
  ...
  const { rangeStartDate, rangeEndDate, firstDataRequest } = periodParams;
...
Datafeeds.SymbolsStorage.prototype._requestFullSymbolsList = function () {
  ...
  for (var i = 0; i < this._exchangesList.length; ++i) {
    ...
    this._datafeed
      ._send(this._datafeed._datafeedURL + '/symbols', {
        group: exchange,
      })
      .done(
        (function (exchange) {
...
Datafeeds.SymbolsStorage.prototype._onExchangeDataReceived = function (
  ...
  try {
    for (var symbolIndex = 0; symbolIndex < data.symbol.length; ++symbolIndex) {
      ...
      this._symbolsInfo[symbolInfo.ticker] =
        this._symbolsInfo[symbolName] =
    ...
    for (var listenerGUID in that._subscribers) {
      ...
      (function (_subscriptionRecord) {
        ...
        that._datafeed.getBars(
          ...
          resolution,
          { rangeStartDate: datesRangeLeft, rangeEndDate: datesRangeRight },
          // datesRangeLeft,
          // datesRangeRight,
          function (bars) {
            that._requestsPending--;
