...
!(function (e, s) {
  ...
  class t {
    ...
    getBars(e, t, r) {
      // this.getBars(s.symbolInfo, s.resolution, {
      //   from: r,
      //   to: t,
      //   countBack: 2,
      //   firstDataRequest: !1,
      // })
      const { from, to, firstDataRequest } = r;
  ...
  class c {
            ...
            .then((e) => {
              ...
              if (void 0 !== e.s) r('unknown_symbol');
                ...
                a({
                  ...
                  minmov:
                    null !==
                      (b = null !== (p = e.minmovement) && void 0 !== p ? p : e.minmov) &&
                    void 0 !== b
                      ? b
                      : 0,
                  minmove2:
                    null !==
                      (g =
                        null !== (y = e.minmovement2) && void 0 !== y ? y : e.minmove2) &&
                    void 0 !== g
                      ? g
                      : e.minmov2,
                  session:
                    null !== (f = e.session) && void 0 !== f ? f : e['session-regular'],
                  session_holidays:
                  ...
                  supported_resolutions:
                    null !==
                      (w =
                        null !==
                          (q =
                            null !== (P = e.supported_resolutions) && void 0 !== P
                              ? P
                              : e['supported-resolutions']) && void 0 !== q
                          ? q
                          : this._configuration.supported_resolutions) && void 0 !== w
                      ? w
                      : [],
                  has_daily:
                    null ===
    ...
    subscribeBars(e, s, t, r, i) {
      ...
      console.log('[subscribeBars]: Method call with subscriberUID:', r);
      subscribeOnStream(
        e,
        s,
        t,
